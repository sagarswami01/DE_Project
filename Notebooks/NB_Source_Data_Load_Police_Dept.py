...
folder_path = "police_dept_data/"
blob_prefix = "police_dept_"
...
api_url = "https://data.sfgov.org/resource/wg3w-h783.json"  # Replace with actual API endpoint
# headers = {"X-App-Token": api_access_token}
limit = 100000  # Set the limit of records to fetch per API call
...
df = spark.read.json("wasbs://bronze@sagarhackathon.blob.core.windows.net/police_dept_data")
df = df.drop("location",":@computed_region_26cr_cadq",":@computed_region_h4ep_8xdi",":@computed_region_jg9y_a9du",":@computed_region_jwn9_ihcz",":@computed_region_qgnn_b9vv",":@computed_region_n4xg_c4py",":@computed_region_nqbw_i6c3")
df.write.format("delta").mode("overwrite").option("overwriteSchema", "true").save("wasbs://bronze@sagarhackathon.blob.core.windows.net/processed_data/police_dept_data")
